    ...
    <header>
      ...
      <div id ="principal">
        ...
        <div id="fil">
          ...
          <div id="jugadores">
              <div id="jugador1" class="datoJ">
                  ...
                  <br />
                  <br />
                  <asp:Label ID="crono1" runat="server" Text="Tiempo:"></asp:Label>
                  <asp:Label ID="tiempo1" runat="server" Text="0:00"></asp:Label>
              </div>
              <div id="jugador2" class="datoJ">
                  ...
                  <br />
                  <br />
                  <asp:Label ID="crono2" runat="server" Text="Tiempo:"></asp:Label>
                  <asp:Label ID="tiempo2" runat="server" Text="0:00"></asp:Label>
              </div>
        ...
        <div class="celda" id="D4">
            ...
            <asp:Button ID="d4" CssClass="ficha" runat="server" BackColor="Green" Height="50px" Width="50px" OnClick="d4_Click" />

        </div>

        <div class="celda" id="E4">

            <asp:Button ID="e4" CssClass="ficha" runat="server" BackColor="Green" Height="50px" Width="50px" OnClick="e4_Click" />
        ...
        <div class="celda" id="D5">
            ...
            <asp:Button ID="d5" CssClass="ficha" runat="server" BackColor="Green" Height="50px" Width="50px" OnClick="d5_Click" />

        </div>

        <div class="celda" id="E5">

            <asp:Button ID="e5" CssClass="ficha" runat="server" BackColor="Green" Height="50px" Width="50px" OnClick="e5_Click" />
        ...
        <asp:Label ID="PT" runat="server" Text="Fin de la Partida"></asp:Label>
        <br />
        <br />
        <div>
        <asp:Button ID="gp" runat="server" Text="Guardar Partida" OnClick="gp_Click" />
            <asp:Button ID="finP" runat="server" Text="Terminar Partida" OnClick="finP_Click" />
        </div>
    </form>
</body>
</html>
