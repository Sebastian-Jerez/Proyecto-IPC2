    ...
    <header id="cabecera">
        ...
        <div id="principal">
            ...
            <fieldset id="botones">
                ...
                <br />
                <asp:Button ID="OX" runat="server" Text="Othello Xtream" Width="195px" OnClick="OX_Click" />
            </fieldset> 
            ...
            <asp:Button ID="Button5" runat="server" Height="25px" Text="Iniciar Sesión" Width="163px" OnClick="Button5_Click" />
                <br />
                <br />
                <asp:Button ID="pu" runat="server" Text="Perfil de Usuario" OnClick="pu_Click" />
            </div>
